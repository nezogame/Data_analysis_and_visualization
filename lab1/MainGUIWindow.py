...
class Window:
    ...
    def __init__(self):
        ...
        self.frequency_chekbox = tk.Label(self.root,text="You will see the next feature").place(x=60,y=130)
        self.frequency_chekbox = tk.Label(self.root,text="Build frequency table").place(x=60,y=160)
        self.frequency_chekbox = tk.Label(self.root,text="Split frequencies table into classes").place(x=60,y=190)
        self.frequency_chekbox = tk.Label(self.root,text="3").place(x=60,y=220)
        self.frequency_chekbox = tk.Label(self.root,text="4").place(x=60,y=250)
        self.frequency_chekbox = tk.Label(self.root,text="5").place(x=60,y=280)
        self.frequency_chekbox = tk.Label(self.root,text="6").place(x=60,y=310)
        self.frequency_chekbox = tk.Label(self.root,text="7").place(x=60,y=340)
        self.frequency_chekbox = tk.Label(self.root,text="8").place(x=60,y=370)
        self.frequency_chekbox = tk.Label(self.root,text="9").place(x=60,y=400)
